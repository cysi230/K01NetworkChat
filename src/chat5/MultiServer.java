...
public class MultiServer {
	...
	public void init() {
		...
		/*
		 ...
		 해당 쓰레드는 1명의 클라이언트가 전송하는 메시지를 읽어서 Echo
		 해주는 역할을 담당한다
		 */
		while(true) {
	...
	/*
	 chat4까지는 init()이 static 이었으나 , chat5부터는 일반적인
	...
	class MultiServerT extends Thread{
		...
		/*
		 ...
		 접속자명과 메세지르 지속적으로 읽어 Echo 해주는 역할을
		 하고있다.
		 */
		@Override
		public void run() {
		...
		try {	
			...
			if(in !=null) {
				...
				out.println("> "+name+"님이 접속하셨습니다");//클라이언트에게 Echo
			}
